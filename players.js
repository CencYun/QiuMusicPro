...
let playersModule = {
    ...
    AutoJsGesturePlayer: function () {
        return new Player(new AutoJsGesturePlayerImpl());
    },
    SimpleInstructPlayer: function () {
        return new Player(new SimpleInstructPlayerImpl());
    },
    SkyCotlLikeInstructPlayer: function () {
        return new Player(new SkyCotlLikeInstructPlayerImpl());
    }
};